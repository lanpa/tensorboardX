...
def make_tsv(metadata, save_path=None):
...
def make_pbtxt(label_img=None, save_path=None):
...
def add_embedding(mat, save_path=None, metadata=None, label_img=None):
    assert save_path is not None, 'please specify path to log files'
    ...
    make_pbtxt(label_img, save_path=save_path)
