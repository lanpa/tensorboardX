...
_EVENT.fields_by_name['summary'].message_type = proto__src_dot_summary__pb2._SUMMARY
...
Event = _reflection.GeneratedProtocolMessageType('Event', (_message.Message,), dict(
  DESCRIPTOR = _EVENT,
  __module__ = 'proto_src.event_pb2'
